...
import shutil  # Directory traversal, file list building.
...
def get_baseincludedirs(name, osname):
    return (
        ["PsychSourceGL/Source/Common/" + name]
        + baseincludes_common
        + ["PsychSourceGL/Source/" + osname + "/Base"]
        + ["PsychSourceGL/Source/" + osname + "/" + name]
    )
...
def get_basesources(name, osname):
    ...
    return (
        basefiles_common
        + get_sourcefiles("./PsychSourceGL/Source/" + osname + "/Base/")
        + get_sourcefiles("./PsychSourceGL/Source/Common/" + name)
        + extrafiles
    )
...
basefiles_common = get_sourcefiles("./PsychSourceGL/Source/Common/Base") + [
    "PsychSourceGL/Source/Common/Base/PythonGlue/PsychScriptingGluePython.c"
]
baseincludes_common = [
    numpy.get_include(),
    "PsychSourceGL/Source/Common/Base",
...
if platform.system() == "Windows":
    ...
    if is_64bits:
        ...
        shutil.copy(
            "PsychSourceGL/Cohorts/libusb1-win32/MS64/dll/libusb-1.0.dll",
            "PsychPython/psychtoolbox/",
        )
        shutil.copy(
            "Psychtoolbox/PsychSound/portaudio_x64.dll", "PsychPython/psychtoolbox/"
        )
        ...
        shutil.copy(
            "PsychSourceGL/Cohorts/libusb1-win32/MS32/dll/libusb-1.0.dll",
            "PsychPython/psychtoolbox/",
        )
        # list them so they get packaged
...
if platform.system() == "Darwin":
    ...
    psychhid_includes = [
        "PsychSourceGL/Cohorts/HID_Utilities_64Bit/",
        "PsychSourceGL/Cohorts/HID_Utilities_64Bit/IOHIDManager",
    ...
    psychhid_extralinkargs = [
        "-weak_library",
        "PsychSourceGL/Cohorts/libusb1-win32/libusb-1.0.dylib",
    ]

    # Extra objects for PsychHID - statically linked HID utilities:
    psychhid_extra_objects = [
        "PsychSourceGL/Cohorts/HID_Utilities_64Bit/build/Release/libHID_Utilities64.a"
    ]
